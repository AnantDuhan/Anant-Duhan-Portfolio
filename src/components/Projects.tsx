...
const badgeColors: Record<string, string> = {
  ...
  default:
    'text-gray-500 dark:text-gray-400 bg-gray-100 dark:bg-dark-bg3 border-gray-200 dark:border-dark-border',
}
  ...
  return (
    <section id="projects" className="py-28 px-6 lg:px-16">
      <div className="max-w-6xl mx-auto" ref={ref}>
        <span className="font-mono text-xs font-medium text-accent tracking-widest block mb-3">
          // selected work
        </span>
        ...
        <p className="text-gray-500 dark:text-gray-400 mb-12 max-w-xl">
          Things I've built — open source and at Bosch.
        </p>
